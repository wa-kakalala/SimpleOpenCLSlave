...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../SimpleOpenCLSlave.srcs/sources_1/bd/system/ipshared/a0fc/hdl/src/verilog" \
       +incdir+"$ref_dir/../../../../SimpleOpenCLSlave.srcs/sources_1/bd/system/ipshared/85a3" \
       +incdir+"../../../../SimpleOpenCLSlave.srcs/sources_1/bd/system/ipshared/a0fc/hdl/src/verilog" \
       +incdir+"../../../../SimpleOpenCLSlave.srcs/sources_1/bd/system/ipshared/85a3"
}
